...
//		imoveis[3] = new Casa(100, 3, 200000, true);
		...
		for (int i = 0; i < im; i++) {
			...
			if (r < 0.5) { //50% casa
				...
				System.out.println("Informe o valor de compra:");
				double preco = s.nextDouble();
				System.out.println("O apartamento possui piscina?");
		...
		Imobiliaria imobiliaria = new Imobiliaria(imoveis);
		
		System.out.println();
		System.out.println("Media do preco de compra dos imoveis: R$ " + imobiliaria.mediaPrecoCompra());
		System.out.println("Quantidade de casas: " + imobiliaria.qtdCasas());
		System.out.println("Quantidade de apartamentos: " + imobiliaria.qtdApartamentos());
		System.out.println("Imovel com maior preco de venda: R$ " + imobiliaria.imovelDeVendaMaisCara());
